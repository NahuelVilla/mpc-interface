...
class DynamicsTestCase(unittest.TestCase):
    def setUp(self):
        ...
        cnt_sys3 = dy.ControlSystem(inputs, states, A, B, axes, time_variant=True)

        self.cnt_sys1 = cnt_sys1
        self.cnt_sys2 = cnt_sys2
        self.cnt_sys3 = cnt_sys3
        self.A = A
        self.B = B
        self.inputs = inputs
        self.states = states
        ...
        self.domVar2 = domVar2
        self.domVar3 = domVar3
        self.domVar4 = domVar4
        self.domVar5 = domVar5
    ...
    def test_extended_control_system(self):
        ...
        self.assertTrue("new_var" + self.ext_sys1.axes[0] in self.ext_sys1.definitions)
